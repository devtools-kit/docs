  ...
  return (
    <div>
      <Tabs
        ...
        variant="fullWidth"
      >
        <StyledTab label={PanelTypes.PARTY_ID} />
        <StyledTab
          label={PanelTypes.SOCIAL_SECURITY_NUMBER_AND_DATE_OF_BIRTH}
        />
        <StyledTab label={PanelTypes.CONSUMER_ID} />
        <StyledTab
          label={PanelTypes.FIRST_NAME_LAST_NAME_DATE_OF_BIRTH_AND_CONTRACT_ID}
        />
        <StyledTab label={PanelTypes.CONTRACT_ID_AND_PERSON_NUMBER} />
        <StyledTab
          label={PanelTypes.FIRST_NAME_LAST_NAME_GROUP_NUMBER_AND_DATE_OF_BIRTH}
        />
      </Tabs>
      <div>
